const HeroDataPrivacy = () => {
  return (
    <section
      id="dataprivacy" // Die ID, auf die der Link verweist
    ...
    >
      ...
      <h1 className="text-3xl font-bold">1. Datenschutz auf einen Blick</h1>
      <br></br>
      <h1 className="text-2xl font-bold">Allgemeine Hinweise</h1> 
      <br></br>
      <p>
        Die folgenden Hinweise geben einen einfachen &Uuml;berblick dar&uuml;ber, was mit Ihren personenbezogenen Daten passiert,
        wenn Sie diese Website besuchen. Personenbezogene Daten sind alle Daten, mit denen Sie pers&ouml;nlich identifiziert
      ...
      <br></br>
      <h1 className="text-2xl font-bold">Datenerfassung auf dieser Website</h1> 
      <br></br>
      <h1 className="text-1xl font-bold">Wer ist verantwortlich f&uuml;r die Datenerfassung auf dieser Website?</h1> 
      <br></br>
      ...
      <br></br>      
      <h1 className="text-1xl font-bold">Wie erfassen wir Ihre Daten?</h1> 
      <br></br>
      ...
      <h1 className="text-1xl font-bold">Wof&uuml;r nutzen wir Ihre Daten?</h1> 
      <br></br>
      <p>
      ...
      <h1 className="text-1xl font-bold">Welche Rechte haben Sie bez&uuml;glich Ihrer Daten?</h1> 
      <br></br>
      <p>
        Sie haben jederzeit das Recht, unentgeltlich Auskunft &uuml;ber Herkunft, Empf&auml;nger und Zweck Ihrer gespeicherten
        personenbezogenen Daten zu erhalten. Sie haben au&szlig;erdem ein Recht, die Berichtigung oder L&ouml;schung dieser Daten
        zu verlangen. Wenn Sie eine Einwilligung zur Datenverarbeitung erteilt haben, k&ouml;nnen Sie diese Einwilligung jederzeit
      ...
      <h1 className="text-3xl font-bold">2. Hosting</h1>  
      <br></br>
      <p>Wir hosten die Inhalte unserer Website bei folgendem Anbieter:</p>
      <br></br>
      <h1 className="text-2xl font-bold">Hostinger</h1>      
      <br></br>
      ...
      <p>
        Das externe Hosting erfolgt zum Zwecke der Vertragserf&uuml;llung gegen&uuml;ber unseren potenziellen und bestehenden
        ...
        Abs. 1 TDDDG, soweit die Einwilligung die Speicherung von Cookies oder den Zugriff auf Informationen im Endger&auml;t des
      ...
      <h1 className="text-3xl font-bold">3. Allgemeine Hinweise und Pflicht&shy;informationen</h1> 
      <br></br>
      ...
      <h1 className="text-2xl font-bold">Hinweis zur verantwortlichen Stelle</h1> 
      <br></br>
      ...
      <h1 className="text-2xl font-bold">Speicherdauer</h1> 
      <br></br>
      ...
      <h1 className="text-2xl font-bold">Allgemeine Hinweise zu den Rechtsgrundlagen der Datenverarbeitung auf dieser Website</h1> 
      <br></br>
      ...
      <p>
        ...
        Drittstaaten erfolgt die Datenverarbeitung au&szlig;erdem auf Grundlage von Art. 49 Abs. 1 lit. a DSGVO. Sofern Sie in die
        Speicherung von Cookies oder in den Zugriff auf Informationen in Ihr Endger&auml;t (z.&nbsp;B. via Device-Fingerprinting)
        eingewilligt haben, erfolgt die Datenverarbeitung zus&auml;tzlich auf Grundlage von &sect; 25 Abs. 1 TDDDG. Die
        Einwilligung ist jederzeit widerrufbar. Sind Ihre Daten zur Vertragserf&uuml;llung oder zur Durchf&uuml;hrung
      ...
      <h1 className="text-2xl font-bold">Empfänger von personenbezogenen Daten</h1> 
      <br></br>
      ...
      <p>
        ...
        berechtigtes Interesse nach Art. 6 Abs. 1 lit. f DSGVO an der Weitergabe haben oder wenn eine sonstige Rechtsgrundlage die
        Datenweitergabe erlaubt. Beim Einsatz von Auftragsverarbeitern geben wir personenbezogene Daten unserer Kunden nur auf
        Grundlage eines g&uuml;ltigen Vertrags &uuml;ber Auftragsverarbeitung weiter. Im Falle einer gemeinsamen Verarbeitung wird
        ein Vertrag &uuml;ber gemeinsame Verarbeitung geschlossen.
      </p>
      <br></br>
      
      <h1 className="text-2xl font-bold">Widerruf Ihrer Einwilligung zur Datenverarbeitung</h1> 
      <br></br>
      ...
      <h1 className="text-2xl font-bold">Widerspruchsrecht gegen die Datenerhebung in besonderen F&auml;llen sowie gegen Direktwerbung (Art. 21 DSGVO)</h1> 
      <br></br>
      ...
      <p>
        ...
        ZWINGENDE SCHUTZW&Uuml;RDIGE GR&Uuml;NDE F&Uuml;R DIE VERARBEITUNG NACHWEISEN, DIE IHRE INTERESSEN, RECHTE UND FREIHEITEN
      ...
      <h1 className="text-2xl font-bold">Beschwerde&shy;recht bei der zust&auml;ndigen Aufsichts&shy;beh&ouml;rde</h1> 
      <br></br>
      ...
      <h1 className="text-2xl font-bold">Recht auf Daten&shy;&uuml;bertrag&shy;barkeit</h1> 
      <br></br>
      ...
      <p>
        ...
        Sofern Sie die direkte &Uuml;bertragung der Daten an einen anderen Verantwortlichen verlangen, erfolgt dies nur, soweit es
        technisch machbar ist.
      </p>
      <br></br>
     
      <h1 className="text-2xl font-bold">Auskunft, Berichtigung und L&ouml;schung</h1> 
      <br></br>
      ...
      <h1 className="text-2xl font-bold">Recht auf Einschr&auml;nkung der Verarbeitung</h1> 
      <br></br>
      ...
      <ul>
        ...
        <li>
          ...
          Zeit, um dies zu &uuml;berpr&uuml;fen. F&uuml;r die Dauer der Pr&uuml;fung haben Sie das Recht, die Einschr&auml;nkung
      ...
      <p>
        ...
        ihrer Speicherung abgesehen &ndash; nur mit Ihrer Einwilligung oder zur Geltendmachung, Aus&uuml;bung oder Verteidigung
        von Rechtsanspr&uuml;chen oder zum Schutz der Rechte einer anderen nat&uuml;rlichen oder juristischen Person oder aus
        Gr&uuml;nden eines wichtigen &ouml;ffentlichen Interesses der Europ&auml;ischen Union oder eines Mitgliedstaats
        verarbeitet werden.
      </p>
      <br></br>
     
      <h1 className="text-2xl font-bold">SSL- bzw. TLS-Verschl&uuml;sselung</h1>
      <br></br>
      ...
      <h1 className="text-3xl font-bold">4. Datenerfassung auf dieser Website</h1> 
      <br></br>
      ...
      <p>
        ...
        automatisch gel&ouml;scht. Permanente Cookies bleiben auf Ihrem Endger&auml;t gespeichert, bis Sie diese selbst
      ...
      <p>
        ...
        erw&uuml;nschter Funktionen (z.&nbsp;B. f&uuml;r die Warenkorbfunktion) oder zur Optimierung der Website (z.&nbsp;B.
        Cookies zur Messung des Webpublikums) erforderlich sind (notwendige Cookies), werden auf Grundlage von Art. 6 Abs. 1 lit.
        f DSGVO gespeichert, sofern keine andere Rechtsgrundlage angegeben wird. Der Websitebetreiber hat ein berechtigtes
        Interesse an der Speicherung von notwendigen Cookies zur technisch fehlerfreien und optimierten Bereitstellung seiner
        Dienste. Sofern eine Einwilligung zur Speicherung von Cookies und vergleichbaren Wiedererkennungstechnologien abgefragt
        wurde, erfolgt die Verarbeitung ausschlie&szlig;lich auf Grundlage dieser Einwilligung (Art. 6 Abs. 1 lit. a DSGVO und
        &sect; 25 Abs. 1 TDDDG); die Einwilligung ist jederzeit widerrufbar.
      </p>{' '}
      <br></br>

      <p>
        Sie k&ouml;nnen Ihren Browser so einstellen, dass Sie &uuml;ber das Setzen von Cookies informiert werden und Cookies nur
        im Einzelfall erlauben, die Annahme von Cookies f&uuml;r bestimmte F&auml;lle oder generell ausschlie&szlig;en sowie das
        automatische L&ouml;schen der Cookies beim Schlie&szlig;en des Browsers aktivieren. Bei der Deaktivierung von Cookies kann
        die Funktionalit&auml;t dieser Website eingeschr&auml;nkt sein.
      </p>{' '}
      <br></br>

      <p>
        Welche Cookies und Dienste auf dieser Website eingesetzt werden, k&ouml;nnen Sie dieser Datenschutzerkl&auml;rung
        entnehmen.
      </p>
      <br></br>
      ...
      <p>
        ...
        Erf&uuml;llung eines Vertrags zusammenh&auml;ngt oder zur Durchf&uuml;hrung vorvertraglicher Ma&szlig;nahmen erforderlich
        ist. In allen &uuml;brigen F&auml;llen beruht die Verarbeitung auf unserem berechtigten Interesse an der effektiven
      ...
      <p>
        ...
        abgeschlossener Bearbeitung Ihrer Anfrage). Zwingende gesetzliche Bestimmungen &ndash; insbesondere Aufbewahrungsfristen
        &ndash; bleiben unber&uuml;hrt.
      </p>
      <br></br>
   
      <h1 className="text-2xl font-bold">Anfrage per E-Mail oder Telefon</h1>
      <br></br>
      ...
      <h1 className="text-3xl font-bold">5. Plugins und Tools</h1>    
      <br></br>
      
      <h1 className="text-1xl font-bold">Google Fonts (lokales Hosting)</h1>
      <br></br>
...
export default HeroDataPrivacy
